export const content = {
  ...
  components: {
    ...
    items: [
      { name: "Hardware", description: "Servers, storage & computing devices" },
      { name: "Cloud", description: "On-demand scalable infrastructure" },
      { name: "Software", description: "Operating systems, tools, and applications" },
      { name: "Security", description: "Protecting data, networks, and systems" },
      { name: "Networks", description: "Seamless connectivity and communication" },
      { name: "IaaS", description: "Infrastructure delivered as a service" },
      { name: "Data Centers", description: "Secure facilities for computing resources" },
      { name: "ITSM", description: "IT service management & operations" }
    ]
  },
  ...
  whyBusiness: {
    ...
    reasons: [
      { title: "Scalability", description: "Easily scale systems as business demand grows" },
      { title: "Security", description: "Protect data, networks, and infrastructure from threats" },
      { title: "Cost Efficiency", description: "Reduce costs with optimized and scalable infrastructure" },
      { title: "Business Continuity", description: "Ensure uptime and reliable disaster recovery" }
    ]
  },

  // Job Roles with Packages
  jobRoles: {
  ...
  webinar: {
    ...
    dateTime: "📅 May 8 \u00A0|\u00A0 ⏰ 10:00 AM IST \u00A0|\u00A0 ⏳ 90 mins",
    cta: "Claim Your Spot",
