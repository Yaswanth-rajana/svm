    ...
    cron.schedule('0 9 * * *', async () => {
        ...
        try {
            ...
            for (const LeadModel of models) {
                ...
                console.log(`🔍 [Scheduler] Query found ${leads.length} leads with paymentStatus: "paid" in ${LeadModel.modelName}`);
    ...
    cron.schedule('*/2 * * * *', async () => {
        ...
        try {
            ...
            for (const LeadModel of models) {
                ...
                console.log(`🔍 [Scheduler] Found ${pendingLeads.length} leads with pending payments older than 15 mins in ${LeadModel.modelName}.`);
    ...
    cron.schedule('*/2 * * * *', async () => {
        ...
        try {
            ...
            for (const LeadModel of models) {
                ...
                console.log(`🔍 [Scheduler] Found ${leads.length} leads eligible for 30-minute reminder in ${LeadModel.modelName}.`);
